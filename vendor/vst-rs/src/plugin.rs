...
impl Host for HostCallback {
    ...
    fn can_do(&self, can_do: &str) -> isize {
        self.callback(self.effect, host::OpCode::CanDo, 0, 0, can_do.as_ptr() as *mut _, 0.0)
    }

    fn get_language(&self) -> i32 {
        self.callback(self.effect, host::OpCode::GetLanguage, 0, 0, ptr::null_mut(), 0.0) as i32
    }
